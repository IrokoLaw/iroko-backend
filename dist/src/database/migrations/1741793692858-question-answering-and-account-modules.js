...
exports.QuestionAnsweringAndAccountModules1741793692858 = void 0;
class QuestionAnsweringAndAccountModules1741793692858 {
    constructor() {
        this.name = 'QuestionAnsweringAndAccountModules1741793692858';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "evaluation" ADD CONSTRAINT "FK_e1f94a9cd0142bcd53d73554ca2" FOREIGN KEY ("chatId") REFERENCES "chats"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "chats" ADD CONSTRAINT "FK_651427eea8b5fa81c39b124c6e8" FOREIGN KEY ("discussionId") REFERENCES "discussion"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "chats" ADD CONSTRAINT "FK_8f5b25eec64568e4e87dc7646f3" FOREIGN KEY ("evaluationId") REFERENCES "evaluation"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE "chats" DROP CONSTRAINT "FK_8f5b25eec64568e4e87dc7646f3"`);
        await queryRunner.query(`ALTER TABLE "chats" DROP CONSTRAINT "FK_651427eea8b5fa81c39b124c6e8"`);
        await queryRunner.query(`ALTER TABLE "evaluation" DROP CONSTRAINT "FK_e1f94a9cd0142bcd53d73554ca2"`);
...
exports.QuestionAnsweringAndAccountModules1741793692858 = QuestionAnsweringAndAccountModules1741793692858;
//# sourceMappingURL=1741793692858-question-answering-and-account-modules.js.map