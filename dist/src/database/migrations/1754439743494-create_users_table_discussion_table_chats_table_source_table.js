...
exports.CreateUsersTableDiscussionTableChatsTableSourceTable1754439743494 = void 0;
class CreateUsersTableDiscussionTableChatsTableSourceTable1754439743494 {
    constructor() {
        this.name = 'CreateUsersTableDiscussionTableChatsTableSourceTable1754439743494';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TYPE "public"."evaluation_note_enum" AS ENUM('BAD', 'USEFUL', 'GREAT', 'NOT_SATISFIED', 'SATISFIED')`);
        await queryRunner.query(`CREATE TABLE "evaluation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "note" "public"."evaluation_note_enum" NOT NULL, "comment" text DEFAULT '', "chatId" uuid NOT NULL, CONSTRAINT "PK_b72edd439b9db736f55b584fa54" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."transactions_currency_enum" AS ENUM('XOF', 'XAF')`);
        await queryRunner.query(`CREATE TYPE "public"."transactions_status_enum" AS ENUM('SUCCESS', 'FAILED')`);
        await queryRunner.query(`CREATE TYPE "public"."transactions_method_enum" AS ENUM('CARD', 'MTN', 'MOOV', 'ORANGE', 'WAVE')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."cards_brand_enum" AS ENUM('VISA', 'MASTERCARD')`);
        await queryRunner.query(`CREATE TYPE "public"."cards_status_enum" AS ENUM('ACTIVATED', 'EXPIRED', 'SUSPENDED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."accounts_type_enum" AS ENUM('SOLO', 'ENTERPRISE')`);
        await queryRunner.query(`CREATE TYPE "public"."accounts_invoicingtype_enum" AS ENUM('MONTHLY', 'ANNUAL', 'TRY')`);
        await queryRunner.query(`CREATE TYPE "public"."accounts_status_enum" AS ENUM('ACTIVATED', 'INACTIVATED', 'PENDING_PAYMENT', 'ARCHIVED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_account_associations_role_enum" AS ENUM('MEMBER', 'OWNER')`);
        await queryRunner.query(`CREATE TABLE "user_account_associations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid NOT NULL, "accountId" uuid NOT NULL, "role" "public"."user_account_associations_role_enum" NOT NULL, CONSTRAINT "PK_7b61f73256b7f0172043edf8e07" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."users_userrole_enum" AS ENUM('USER', 'ADMIN', 'SUPER_ADMIN')`);
        ...
        await queryRunner.query(`CREATE TABLE "discussion" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying NOT NULL, "userId" uuid NOT NULL, CONSTRAINT "PK_b93169eb129e530c6a4c3b9fda1" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."chats_documenttypes_enum" AS ENUM('CONSTITUTION', 'DECREES', 'TREATIES', 'ORDERS', 'LAWS', 'JURISPRUDENCE', 'ORDINANCES', 'CIRCULARS')`);
        await queryRunner.query(`CREATE TYPE "public"."chats_legalsubjects_enum" AS ENUM('labor_law', 'all')`);
        await queryRunner.query(`CREATE TABLE "chats" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "question" text NOT NULL, "answer" text NOT NULL, "documentTypes" "public"."chats_documenttypes_enum" array, "legalSubjects" "public"."chats_legalsubjects_enum" array, "discussionId" uuid NOT NULL, CONSTRAINT "PK_0117647b3c4a4e5ff198aeb6206" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."source_bloc_enum" AS ENUM('REGLEMENTAIRE', 'LEGISLATIF', 'COMMUNAUTAIRE', 'ACTES')`);
        await queryRunner.query(`CREATE TYPE "public"."source_status_enum" AS ENUM('ABROGE', 'EN VIGUEUR', 'MODIFIE(EN VIGUEUR)')`);
        await queryRunner.query(`CREATE TYPE "public"."source_legaltexttype_enum" AS ENUM('LOI', 'ORDONNANCE', 'DECRET', 'ARRETE', 'JURISPRUDENCE', 'TRAITE OHADA', 'DOCTRINE')`);
        await queryRunner.query(`CREATE TYPE "public"."source_action_enum" AS ENUM('PRECISION', 'MODIFICATION', 'MISE EN APPLICATION', 'RAS')`);
        await queryRunner.query(`CREATE TABLE "source" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "legalTextName" character varying, "bloc" "public"."source_bloc_enum", "status" "public"."source_status_enum", "legalTextType" "public"."source_legaltexttype_enum", "action" "public"."source_action_enum", "book" character varying, "title" character varying, "titleNumber" character varying, "chapter" character varying, "chapterNumber" character varying, "section" character varying, "sectionNumber" character varying, "articleNumber" character varying, "pathDoc" character varying, "pathMetadata" character varying, "chatId" uuid NOT NULL, "reference" character varying DEFAULT '', "page" integer NOT NULL DEFAULT '1', CONSTRAINT "PK_018c433f8264b58c86363eaadde" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user_account_associations" ADD CONSTRAINT "FK_dd19fc1e84bd7acbcd39230b094" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_account_associations" ADD CONSTRAINT "FK_a430de6a3c67425b1321a28c851" FOREIGN KEY ("accountId") REFERENCES "accounts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "discussion" ADD CONSTRAINT "FK_46cd2bce5e4070e584cac333d2c" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "chats" ADD CONSTRAINT "FK_651427eea8b5fa81c39b124c6e8" FOREIGN KEY ("discussionId") REFERENCES "discussion"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "source" ADD CONSTRAINT "FK_d8ab2d4bfb1c716b6b567bb6953" FOREIGN KEY ("chatId") REFERENCES "chats"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE "source" DROP CONSTRAINT "FK_d8ab2d4bfb1c716b6b567bb6953"`);
        await queryRunner.query(`ALTER TABLE "chats" DROP CONSTRAINT "FK_651427eea8b5fa81c39b124c6e8"`);
        await queryRunner.query(`ALTER TABLE "discussion" DROP CONSTRAINT "FK_46cd2bce5e4070e584cac333d2c"`);
        await queryRunner.query(`ALTER TABLE "user_account_associations" DROP CONSTRAINT "FK_a430de6a3c67425b1321a28c851"`);
        await queryRunner.query(`ALTER TABLE "user_account_associations" DROP CONSTRAINT "FK_dd19fc1e84bd7acbcd39230b094"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."user_account_associations_role_enum"`);
...
exports.CreateUsersTableDiscussionTableChatsTableSourceTable1754439743494 = CreateUsersTableDiscussionTableChatsTableSourceTable1754439743494;
//# sourceMappingURL=1754439743494-create_users_table_discussion_table_chats_table_source_table.js.map