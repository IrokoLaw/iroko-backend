...
export declare class QuestionAnsweringHandler {
    ...
    constructor(discussionRepository: DiscussionRepositoryPort, chatRepository: ChatRepositoryPort, sourceRepository: SourceRepositoryPort, evaluationRepository: EvaluationRepositoryPort, fileStorage: GCSService);
