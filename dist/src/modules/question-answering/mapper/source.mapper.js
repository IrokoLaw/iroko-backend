...
exports.sourceSchema = zod_1.z.object({
    ...
    page: zod_1.z.number().int().default(1),
});
let SourceMapper = class SourceMapper {
    toDomain(dbEntity) {
        const { id, createdAt, updatedAt, legalTextName, bloc, status, legalTextType, action, book, title, titleNumber, chapter, chapterNumber, section, sectionNumber, articleNumber, pathDoc, pathMetadata, chatId, reference, page, } = dbEntity;
